...
module InstructionMemory(Address, Instruction); 
    ...
    initial begin
        ...
        memory[10] = 32'b00000001001010001001000000010001;    //            addi    $s3, $s3, 0
        ...
        memory[26] = 32'b00000001001010001001000000010001;    //            addi    $s3, $s3, 0
        ...
        memory[25] = 32'b00000001001010001001000000010000;    //    done_branching:    addi    $s2, $s2, 0
        memory[26] = 32'b00000001001010001001000000010001;    //            addi    $s3, $s3, 0
        memory[27] = 32'b00000010011100101000000000100000;    //            add    $s0, $s3, $s2
        memory[28] = 32'b00101001001110010000000000111100;    //            slti    $t9, $t1, 60
        memory[29] = 32'b00101001000110000000000000111100;    //            slti    $t8, $t0, 60
        memory[30] = 32'b00010010001100000000000000000010;    //            beq    $s1, $s0, equal_to
        memory[31] = 32'b00000010000100010101000000101010;    //            slt    $t2, $s0, $s1
        memory[32] = 32'b00010001010000000000000000000011;    //            beq    $t2, $zero, no_new_SAD
        memory[33] = 32'b00000010000000001000100000100000;    //    equal_to:    add    $s1, $s0, $zero
        ...
        memory[12] = 32'b00000001001010001001000000010000;    //            addi    $s2, $s2, 0                     TURN INTO UPPER SAD
        memory[13] = 32'b00000001001010001001100000010001;    //            addi    $s3, $s3, 0                     TURN INTO LOWER SAD
        memory[14] = 32'b00000010011100101000000000100000;    //            add    $s0, $s3, $s2
        memory[15] = 32'b00100000000101100000000000111100;    //            addi    $s6, $zero, 60
        memory[16] = 32'b00100000000101110000000000111100;    //            addi    $s7, $zero, 60
        memory[17] = 32'b00000010000000001000100000100000;    //            add    $s1, $s0, $zero
        ...
        memory[23] = 32'b00100000000010010000000000000000;    //    at_right:    addi    $t1, $zero, 0
        memory[24] = 32'b00100001000010000000000000000001;    //            addi    $t0, $t0, 1
        memory[25] = 32'b00000001001010001001000000010000;    //    done_branching:    addi    $s2, $s2, 0          TURN INTO UPPER SAD
        memory[26] = 32'b00000001001010001001100000010001;    //            addi    $s3, $s3, 0                     TURN INTO LOWER SAD
        memory[27] = 32'b00000010011100101000000000100000;    //            add    $s0, $s3, $s2
        memory[28] = 32'b00101001001110010000000000111100;    //            slti    $t9, $t1, 60
        memory[29] = 32'b00101001000110000000000000111100;    //            slti    $t8, $t0, 60
        memory[30] = 32'b00010010001100000000000000000010;    //            beq    $s1, $s0, equal_to
        ...
        memory[34] = 32'b00000001000000000001000000100000;    //            add    $v0, $t0, $zero
        memory[35] = 32'b00000001001000000001100000100000;    //            add    $v1, $t1, $zero
        memory[36] = 32'b00010111000000001111111111101111;    //    no_new_SAD:    bne    $t8, $zero, main_loop     NEED MANUAL OFFSET
        memory[37] = 32'b00010111001000001111111111101110;    //            bne    $t9, $zero, main_loop            NEED MANUAL OFFSET
        memory[38] = 32'b10001111101111110000000000000000;    //    done:        lw    $ra, 0($sp)
        memory[39] = 32'b00100011101111010000000000000100;    //            addi    $sp, $sp, 4
        memory[40] = 32'b00000011111000000000000000001000;    //            jr    $ra*/
        ...
        memory[10] = 32'b10101111101111110000000000000000;    //            sw    $ra, 0($sp)
        memory[11] = 32'b00100000000100010111111111111111;    //            addi    $s1, $zero, 32767
        memory[12] = 32'b 000000 01001 01000 10000 00000 010000;    //            sad     $s0, $t1, $t0                 TURN INTO SAD
        memory[13] = 32'b00100000000101100000000000111100;    //            addi    $s6, $zero, 60
        memory[14] = 32'b00100000000101110000000000111100;    //            addi    $s7, $zero, 60
        ...
        memory[23] = 32'b00000001001010001000000000010000;    //            sad     $s0, $t1, $t0                 TURN INTO SAD
        memory[24] = 32'b00101001001110010000000000111100;    //            slti    $t9, $t1, 60
        memory[25] = 32'b00101001000110000000000000111100;    //            slti    $t8, $t0, 60
        memory[26] = 32'b00010010001100000000000000000010;    //            beq    $s1, $s0, equal_to
        memory[27] = 32'b00000010000100010101000000101010;    //            slt    $t2, $s0, $s1
        memory[28] = 32'b00010001010000000000000000000011;    //            beq    $t2, $zero, no_new_SAD
        ...
        memory[32] = 32'b00010111000000001111111111110001;    //    no_new_SAD:    bne    $t8, $zero, main_loop
        memory[33] = 32'b00010111001000001111111111110000;    //            bne    $t9, $zero, main_loop
        memory[34] = 32'b10001111101111110000000000000000;    //    done:        lw    $ra, 0($sp)
        memory[35] = 32'b00100011101111010000000000000100;    //            addi    $sp, $sp, 4
        memory[36] = 32'b00000011111000000000000000001000;    //            jr    $ra*/
        ...
        memory[10] = 32'b10101111101111110000000000000000;    //            sw    $ra, 0($sp)
        memory[11] = 32'b00100000000100010111111111111111;    //            addi    $s1, $zero, 32767
        memory[12] = 32'b00000001001010001000000000010000;    //            sad     $s0, $t1, $t0                 TURN INTO SAD
        memory[13] = 32'b00100000000101100000000000111100;    //            addi    $s6, $zero, 60
        memory[14] = 32'b00100000000101110000000000111100;    //            addi    $s7, $zero, 60
        memory[15] = 32'b00000010000000001000100000100000;    //            add    $s1, $s0, $zero
        memory[16] = 32'b00000001001000000001000000100000;    //            add    $v0, $t1, $zero
        ...
        memory[21] = 32'b00100000000010010000000000000000;    //    at_right:    addi    $t1, $zero, 0
        memory[22] = 32'b00100001000010000000000000000001;    //            addi    $t0, $t0, 1
        memory[23] = 32'b00000001001010001000000000010000;    //    done_branching:    sad  $s0, $t1, $t0      TURN INTO SAD
        memory[24] = 32'b00101001001110010000000000111100;    //            slti    $t9, $t1, 60
        memory[25] = 32'b00010010001100000000000000000011;    //            beq    $s1, $s0, equal_to
        memory[26] = 32'b00000010000100010101000000101010;    //            slt    $t2, $s0, $s1
        ...
        memory[14] = 32'b00000001001010001000000000010000;    //            sad     $s0, $t1, $t0                 TURN INTO SAD
        memory[15] = 32'b00000010000000001000100000100000;    //            add    $s1, $s0, $zero
        memory[16] = 32'b00000001001000000001000000100000;    //            add    $v0, $t1, $zero
        memory[17] = 32'b00000001000000000001100000100000;    //            add    $v1, $t0, $zero
        memory[18] = 32'b00010001001101100000000000000010;    //    main_loop:    beq    $t1, $s6, at_right
        ...
        memory[30] = 32'b00000001000000000001000000100000;    //            add    $v0, $t0, $zero
        memory[31] = 32'b00000001001000000001100000100000;    //            add    $v1, $t1, $zero
        memory[32] = 32'b00010111000000001111111111110011;    //    no_new_SAD:    bne    $t8, $zero, main_loop
        memory[33] = 32'b00010111001000001111111111110010;    //            bne    $t9, $zero, main_loop
        memory[34] = 32'b10001111101111110000000000000000;    //    done:        lw    $ra, 0($sp)
        memory[35] = 32'b00100011101111010000000000000100;    //            addi    $sp, $sp, 4
        memory[36] = 32'b00000011111000000000000000001000;    //            jr    $ra*/
