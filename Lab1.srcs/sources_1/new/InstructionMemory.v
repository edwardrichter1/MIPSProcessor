...
module InstructionMemory(Address, Instruction); 
    ...
    initial begin
        ...
        InstructionReg[7] = 32'b00110101011011110000000000001100; // ori $t7, $t3, 12
        InstructionReg[8] = 32'b00000001100010011000000000100101; // or $s0, $t4, $t1
        InstructionReg[9] = 32'b00000001011011001000100000100111; //nor $s1, $t3, $t4
        InstructionReg[10] = 32'b00000001010010001001000000100110; // xor $s2, $t2, $t0
        InstructionReg[11] = 32'b00111001100100110000000000001010; // xori $s3, $t4, 10
        InstructionReg[12] = 32'b00000001110100111010000000101010; // slt $s4, $t6, $s3
        InstructionReg[13] = 32'b00000001001010001010000000101010; // slt $s4, $t1, $t0
        InstructionReg[14] = 32'b00101001100101010000000000101011; // slti $s5, $t4, 43
        InstructionReg[15] = 32'b00101001110101010000000000000001; // slti $s5, $t6, 1
        InstructionReg[16] = 32'b00000001000010011011000000100001; // addu $s6, $t0, $t1
        InstructionReg[17] = 32'b00100101010101100000000000000111; // addiu $s6, $t2, 7
        InstructionReg[18] = 32'b00000001000011011011100001000110; // rotrv $s7, $t5, $t0
        InstructionReg[19] = 32'b00000000000100101001000010000000; // sll $s2, $s2, 2
        InstructionReg[20] = 32'b00000000000011010110100010000010; // srl $t5, $t5, 2
        InstructionReg[21] = 32'b00000000001011011011100111000010; // rotr $s7, $t5, 7
        InstructionReg[22] = 32'b00000001000010010000000000011000; // mult $t0, $t1
        InstructionReg[23] = 32'b00000001001010100000000000011001; // multu	$t1, $t2
        InstructionReg[24] = 32'b00101001001010001111111111111110; // slti $t0, $t1, -2
        InstructionReg[25] = 32'b00000001100010110100100000101011; // sltu $t1, $t4, $t3
        InstructionReg[26] = 32'b00101101100010011111111111111110; // sltiu $t1, $t4, -2
        InstructionReg[27] = 32'b01111100000100000101011000100000; //seh $t2, $s0
        InstructionReg[28] = 32'b01111100000100010101011000100000; //seh $t2, $s1
        InstructionReg[29] = 32'b01111100000101110101110000100000; //seb $t3, $s7
        InstructionReg[30] = 32'b00000010110010110110000000001010; // movz $t4, $s6, $t3
        InstructionReg[31] = 32'b00000010111100110110100000001010; // movz $t5, $s7, $s3
